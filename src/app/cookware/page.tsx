            ...
            <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
              ...
              <div style={{ flex: 1, minWidth: '200px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(207, 168, 95, 0.2)', paddingTop: '1.5rem' }}>
                  ...
                  <Button href={`https://wa.me/917600026495?text=${encodeURIComponent(`Hello Ritam Global, I am interested in a bulk inquiry for your Cookware: ${selectedProduct.name} (${selectedProduct.size} cm).`)}`} variant="primary" target="_blank">Bulk Inquiry</Button>
                </div>
              </div>
            </div>
          </div>
