...
export const metadata: Metadata = {
  title: "About Us | Ritam Global",
  description: "Learn about Ritam Global's heritage and our commitment to crafting premium incense and traditional cookware.",
};
  ...
  return (
    <div style={{ padding: '6rem 0', minHeight: '80vh', backgroundColor: 'var(--color-ivory)' }}>
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <div className="glass animate-fade-up" style={{ animationDelay: '0.2s', padding: '3rem', borderRadius: 'var(--radius-lg)', marginBottom: '3rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
          <div className="glass animate-fade-up" style={{ animationDelay: '0.4s', padding: '2rem', borderRadius: 'var(--radius-md)', textAlign: 'center' }}>
          ...
          <div className="glass animate-fade-up" style={{ animationDelay: '0.6s', padding: '2rem', borderRadius: 'var(--radius-md)', textAlign: 'center' }}>
        ...
        <div className="animate-fade-up" style={{ animationDelay: '0.8s', textAlign: 'center', padding: '3rem', backgroundColor: 'var(--color-cream)', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(207, 168, 95, 0.2)' }}>
